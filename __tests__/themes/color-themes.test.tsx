...
describe("color themes", () => {
  it("includes Handyst-Neo as a neutral-based theme with white button tokens", () => {
    const neo = COLOR_THEMES["openhands-neo"];

    expect(neo.label).toBe("Handyst-Neo");
  ...
  it("injects white primary tokens when applying Handyst-Neo", () => {
