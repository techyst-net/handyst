...
const config = {
  ...
  productName: "Handyst Agent Canvas",
  ...
  dmg: {
    title: "Handyst Agent Canvas",
    contents: [
      { x: 130, y: 220 },
      { x: 410, y: 220, type: "link", path: "/Applications" },
    ],
    window: { width: 540, height: 380 },
    // Default is "Handyst Agent Canvas-<version>-<arch>.dmg"; GitHub release
    ...
    artifactName: "Handyst-Agent-Canvas-${version}-${arch}.${ext}",
  },
  ...
  nsis: {
    ...
    // The default artifact name is "Handyst Agent Canvas Setup <version>.exe";
    ...
    artifactName: "Handyst-Agent-Canvas-Setup-${version}.${ext}",
  },
