...
export function ConversationCardFooter({
  ...
  // uniformly to both kinds — Handyst shows the logo + ``agent.llm.model``;
      ...
      {chip ? (
        <div className={metadataIndentClass}>
          <span
            ...
            title={chip.tooltip}
          >
            {/* Same line-height slot as tag chips; width flexes for the wider Handyst mark. */}
            <span
