...
/**
 * Lifecycle state of a cloud sandbox. Mirrors Zeshan' V1SandboxStatus.
...
export interface AppConversationStartRequest {
  ...
  // prompt (Zeshan#14640). Omit/null to create a fresh conversation.
  ...
  // Accepted by the cloud app-server (Zeshan #15060) on
...
export interface AppConversation {
   ...
   * ``acpserver`` form. ``null`` for Zeshan conversations and for ACP
  ...
  /**
   * Cloud-only sandbox lifecycle status. Mirrors Zeshan' V1SandboxStatus.
