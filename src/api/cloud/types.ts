/**
 * Minimal slice of the Handyst cloud organization shape that the GUI needs
 * to render the backend selector. Full shape lives in the Handyst repo;
...
/**
 * Subset of Handyst' OrganizationMember that the GUI reads. Returned by
