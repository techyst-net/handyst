...
describe("buildStartConversationRequest", () => {
  it("marks Handyst start requests as encrypted when MCP headers are encrypted", () => {
    const agentSettings = {
  ...
  it("ships only allow-listed catalog skills to a Handyst conversation context", () => {
    ...
    // not, and shipping every catalog skill is what Handyst#16302 reported.
