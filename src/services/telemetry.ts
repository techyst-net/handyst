 ...
 *
 * AD BLOCKER BYPASS:
 * By default, telemetry is routed through Zeshan' reverse proxy (z.openhands.dev)
 ...
 *
 * IMPORTANT: By default, telemetry is sent to the Zeshan PostHog project.
...
// Default to Zeshan' reverse proxy to bypass ad blockers.
